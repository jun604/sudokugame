...
---
Python 기반으로 제작된 스도쿠 게임 생성 & 플레이 프로그램입니다.<br>
오리지널 스도쿠와 크로스 스도쿠를 지원하며, Tkinter 기반의 GUI로 쉽고 직관적인 조작이 가능합니다.<br>
난이도는 3단계로 조절 할 수 있습니다.<br>
...
퍼즐 생성 시 로딩 화면 표시
- 소요 시간 10초 ~ 2분(생성되는 보드에 따라 편차 심함)
